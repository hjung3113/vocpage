...
**Hard rule:** **never hardcode hex or raw OKLCH values** in prototype HTML. If a token doesn't exist, add it to `design.md` first, then use it here. A prototype with hex values silently drifts from the real design system.
