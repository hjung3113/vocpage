...
- [ ] **AI 워크플로우 적합성 리뷰 반영** (`reviews/phase6/voc-ai-workflow-fit-review.md`)
  ...
  - **다음 세션 시작점** (우선순위 순):
    ...
    - [x] **7B 필드별 마스터 매핑**: `related_programs/db_tables/jobs/sps/equipment/maker/model/process` 각 필드의 원천 시스템·owner·엔드포인트·스키마. `docs/specs/requires/external-masters.md` 작성 완료. ✅ 2026-04-24
