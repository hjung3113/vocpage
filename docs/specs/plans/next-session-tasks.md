...
> 최종 업데이트: 2026-05-09 (Wave 3 Phase B + C 머지 완료)
> 현재 위치: **Wave 3 Phase B + C 머지 완료 — Phase D (External Masters) + Phase E (Users) 병렬 진입 가능**
...
| **3**         | [`wave-3-admin.md`](./wave-3-admin.md) + ADR [`0004`](../../adr/0004-admin-permission-model.md) (Accepted) / [`0005`](../../adr/0005-trash-restore-policy.md) (Accepted) | 🟡 **Phase A + B + C 머지 완료 (2026-05-09)** — Phase A: PR #250/#251/#252/#254/#253. **Phase B**: PR #262 (W3-4 Tag Master) `9959ed0` + codex P1/P2 fix. **Phase C**: PR #263 (W3-5 Trash) `fa3986c` + codex P0/P1 + visual P2 fix. **다음**: Phase D (External Masters `/admin/masters`) + Phase E (Users `/admin/users`) 병렬 진입. |
...
~~FSD Migration~~ → ~~`/voc 완성` PR #242~~ → ~~Wave 4 PR #245~~ → ~~Wave 3 Phase A (4 PR + hotfix)~~ → ~~Wave 3 Phase B+C (PR #262/#263, 2026-05-09)~~ → **Phase D+E 병렬** → Phase F 종합 검증 → Wave 5 plan 작성 → Wave 2 (Dashboard).
