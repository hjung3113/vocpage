...
| 3       | Admin 4 화면 (Tag Master / Trash / External Masters / Users)                                                  | 🟢 OQ closed, ADR Accepted | [`wave-3-admin.md`](./wave-3-admin.md) + ADR [`0004`](../../adr/0004-admin-permission-model.md) / [`0005`](../../adr/0005-trash-restore-policy.md) |
