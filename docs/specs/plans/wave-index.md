...
| 3       | Admin 4 화면 (Tag Master / Trash / External Masters / Users)                                                  | 🟡 Phase A 4 PR + hotfix 머지 (2026-05-09) — Phase B/C 진입 가능 | [`wave-3-admin.md`](./wave-3-admin.md) + ADR [`0004`](../../adr/0004-admin-permission-model.md) / [`0005`](../../adr/0005-trash-restore-policy.md) |
